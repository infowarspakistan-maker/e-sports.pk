...
import { getFirestore, doc, setDoc, collection, addDoc, initializeFirestore } from 'firebase/firestore';
...
async function seed() {
  ...
  const cred = await createUserWithEmailAndPassword(auth, randomEmail, "password123");
